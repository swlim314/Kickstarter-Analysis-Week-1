...
### Purpose
After Louise launched her Kickstarter for her play *Fever* requested an analysis of available Kickstarter data to determine an optimal timeframe to launch a kickstarter, as well as determining proper goalsetting for crowdfunding.  
